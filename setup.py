...
def find_from_doc(what='version'):
    f = open(os.path.join(os.path.dirname(__file__), 'pyplint/__init__.py')).read()
...
if __name__ == '__main__':
    setup(
        ...
        description='Pure python package for Picard-Lefschetz Integral',
        long_description=open('README.md').read(),
        long_description_content_type='text/markdown',
        url=find_from_doc('url'),
        author=find_from_doc('author'),
        author_email='sunaosugiyama@gmail.com',
        keywords=['Picard-Lefschetz', 'numerical integral'],
        packages=['pyplint'],
